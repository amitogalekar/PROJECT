...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-center py-5">Email</h1>
      <form id="frm" style="margin: 0px auto;">
        ...
        <div class="col-6 text-center" style="margin: 20px auto;">
          <button onclick="return validate()" type="submit" class="btn btn-primary px-5" >send OTP</button>
        </div>
...
<script src="assets/MyJS/sendOTP.js"></script>
<style>
body {
