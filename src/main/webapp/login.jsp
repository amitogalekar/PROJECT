  ...
  <div class="container-fluid">
    ...
    <div class="row" style="margin: 0px auto;display: block;">
        ...
        <div class="col-6 text-center" style="margin: 20px auto;">
          <button onclick="return validateLoginForm()" type="submit" class="btn btn-primary px-5" >login</button>
        </div>

        <div class="row" style="margin: 0px auto;display: block;">        
            <div class="col-md-6" style="margin: 0px auto">
              <p style="display: inline-block;" for="email" class="form-label">Not Registered ? <a href="regFrm.jsp">Click here</a></p><p style="float: right;display: inline-block;" for="email" class="form-label"><a href="getEmail.jsp">forgot password ?</a></p>
...
<script src="assets/MyJS/validatelogin.js"></script>
