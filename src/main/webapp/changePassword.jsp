  ...
  <div class="row p-5 shadow my-5 bg-body rounded" >
    ...
    <div class="row" style="margin: 0px auto;display: block;">
        <div class="col-md-6" style="margin: 0px auto">
          <label for="password" class="form-label text-center">Old Password</label>
          <input type="password" class="form-control" id="old_password" name="old_password">
          <span style="color:red" id="old_passwordError"></span>
        </div>
    </div>
    <div class="row" style="margin: 0px auto;display: block;">
        <div class="col-md-6" style="margin: 0px auto">
          ...
          <span style="color:red" id="new_passwordError"></span>
        </div>
    </div>
    <div class="row" style="margin: 0px auto;display: block;">
        <div class="col-md-6" style="margin: 0px auto">
          ...
          <span style="color:red;" class="text-left" id="cnfrm_passwordError"></span>
        </div>
    </div>
        
        <div class="col-6 text-center" style="margin: 20px auto;">
          <button onclick="return validateChangePwdForm()" type="submit" class="btn btn-primary px-5" >Submit</button>
        </div>
...
<script src="assets/MyJS/validateChangePassword.js"></script>
<style>
